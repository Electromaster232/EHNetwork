...
/**
 * <p>Java class for PoolConfigurationList complex type.
 * 
...
@XmlType(name = "PoolConfigurationList", propOrder = {
    "poolDefinitions"
})
public class PoolConfigurationList {

    @XmlElement(required = true)
    protected List<PoolConfiguration> poolDefinitions;
     ...
     * 
     */
    public List<PoolConfiguration> getPoolDefinitions() {
        if (poolDefinitions == null) {
            poolDefinitions = new ArrayList<PoolConfiguration>();
        }
