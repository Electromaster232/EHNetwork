...
/**
 * <p>Java class for SimpleFailoverPool complex type.
 * 
...
@XmlType(name = "SimpleFailoverPool", propOrder = {
    "zoneName",
    "hostName",
    "description",
    "liveRecord",
...
public class SimpleFailoverPool {
     ...
     *     
     */
    public void setStatus(ARStatusEnum value) {
        this.status = value;
    }
