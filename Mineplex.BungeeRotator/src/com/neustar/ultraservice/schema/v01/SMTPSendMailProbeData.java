...
/**
 * <p>Java class for SMTPSendMailProbeData complex type.
 * 
...
@XmlType(name = "SMTPSendMailProbeData")
public class SMTPSendMailProbeData {
    ...
    @XmlAttribute(name = "mailToAddress")
