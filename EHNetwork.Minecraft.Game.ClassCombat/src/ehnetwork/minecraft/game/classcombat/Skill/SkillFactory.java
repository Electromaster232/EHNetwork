...
import ehnetwork.minecraft.game.classcombat.Skill.Assassin.Illusion;
...
public class SkillFactory extends MiniPlugin implements ISkillFactory
{
	...
	public void AddAssassin()
	{
		...
		AddSkill(new Illusion(this, "Illusion", IPvpClass.ClassType.Assassin, ISkill.SkillType.Sword,
				1, 4, 
				50, -4, 
				17000, -1000, true,
				new Material[] {Material.IRON_SWORD, Material.GOLD_SWORD, Material.DIAMOND_SWORD}, 
