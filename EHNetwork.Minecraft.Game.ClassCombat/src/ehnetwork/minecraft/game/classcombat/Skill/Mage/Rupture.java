...
public class Rupture extends SkillActiveCharge
{
	...
	public Rupture(SkillFactory skills, String name, IPvpClass.ClassType classType, SkillType skillType,
				   int cost, int levels,
	...
	{
		Block targetBlock = cur.getTargetBlock((Set) new ArrayList<Material>(), 0);
