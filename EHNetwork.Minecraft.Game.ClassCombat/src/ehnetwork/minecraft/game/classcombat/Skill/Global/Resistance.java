...
import ehnetwork.minecraft.game.core.condition.events.ConditionApplyEvent;

public class Resistance extends Skill
{
	public Resistance(SkillFactory skills, String name, IPvpClass.ClassType classType, SkillType skillType, int cost, int levels)
	{
