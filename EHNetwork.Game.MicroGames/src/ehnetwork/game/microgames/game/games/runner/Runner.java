package ehnetwork.game.microgames.game.games.runner;
...
import ehnetwork.game.microgames.game.games.runner.kits.KitArcher;
import ehnetwork.game.microgames.game.games.runner.kits.KitFrosty;
import ehnetwork.game.microgames.game.games.runner.kits.KitLeaper;
import ehnetwork.game.microgames.kit.Kit;
import ehnetwork.game.microgames.stats.DistanceTraveledStatTracker;

public class Runner extends SoloGame implements IThrown
{
	private HashMap<Block, Long> _blocks = new HashMap<Block, Long>(); 
	
	public Runner(MicroGamesManager manager)
	{
