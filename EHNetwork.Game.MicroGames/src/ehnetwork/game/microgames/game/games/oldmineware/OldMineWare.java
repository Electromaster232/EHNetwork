package ehnetwork.game.microgames.game.games.oldmineware;
...
import ehnetwork.game.microgames.game.games.oldmineware.random.ActionMilkCow;
import ehnetwork.game.microgames.game.games.oldmineware.random.ActionShearSheep;
import ehnetwork.game.microgames.game.games.oldmineware.random.CraftLadder;
import ehnetwork.game.microgames.game.games.oldmineware.random.CraftStoneShovel;
import ehnetwork.game.microgames.game.games.oldmineware.random.DamageChicken;
import ehnetwork.game.microgames.game.games.oldmineware.random.DamageFall;
import ehnetwork.game.microgames.game.games.oldmineware.random.DamageGhast;
import ehnetwork.game.microgames.game.games.oldmineware.random.GatherCobble;
import ehnetwork.game.microgames.game.games.oldmineware.random.GatherRedFlower;
import ehnetwork.game.microgames.game.games.oldmineware.random.GatherSand;
import ehnetwork.game.microgames.game.games.oldmineware.random.GatherYellowFlower;
import ehnetwork.game.microgames.game.games.oldmineware.random.PlaceDoor;
import ehnetwork.game.microgames.game.games.oldmineware.random.RideBoat;
import ehnetwork.game.microgames.game.games.oldmineware.random.RidePig;
import ehnetwork.game.microgames.game.games.oldmineware.random.StandAlone;
import ehnetwork.game.microgames.game.games.oldmineware.random.StandShelter;
import ehnetwork.game.microgames.game.games.oldmineware.random.StandStone;
import ehnetwork.game.microgames.game.games.oldmineware.random.StandWater;
import ehnetwork.game.microgames.game.games.runner.kits.KitLeaper;
...
public class OldMineWare extends SoloGame
{
	...
	public OldMineWare(MicroGamesManager manager)
	{
