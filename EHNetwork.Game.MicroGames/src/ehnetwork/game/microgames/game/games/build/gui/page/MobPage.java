...
import ehnetwork.game.microgames.game.games.build.gui.MobShop;

public class MobPage extends ShopPageBase<MicroGamesManager, MobShop>
{
	private BuildData _buildData;
	private Entity _entity;


	public MobPage(MicroGamesManager plugin, MobShop shop, CoreClientManager clientManager, DonationManager donationManager, Player player, BuildData buildData, Entity entity)
	{
