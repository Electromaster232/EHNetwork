...
import ehnetwork.game.microgames.shop.KitPackage;
...
public class GamePlayerManager implements Listener
{
	...
	public GamePlayerManager(MicroGamesManager manager)
	{
		Manager = manager;
	...
	public void PlayerJoin(PlayerJoinEvent event)
	{
		...
		//Player List
		UtilTabTitle.setHeaderAndFooter(player, "§6§lMicro Games",
	...
	public void KitClick(final Player player, final Kit kit, final Entity entity)
	{
		...
		{
			Manager.GetShop().openPageForPlayer(player, new ConfirmationPage<MicroGamesManager, ArcadeShop>(
