...
public abstract class Kit implements Listener
{
	...
	public Kit(MicroGamesManager manager, String name, KitAvailability kitAvailability, String[] kitDesc, Perk[] kitPerks, EntityType entityType, ItemStack itemInHand)
	{
		this(manager, name, kitAvailability, 2000, kitDesc, kitPerks, entityType, itemInHand);
	}

	public Kit(MicroGamesManager manager, String name, KitAvailability kitAvailability, int cost, String[] kitDesc, Perk[] kitPerks, EntityType entityType, ItemStack itemInHand)
	{
		Manager = manager;
