...
import ehnetwork.game.microgames.gui.privateServer.button.BanButton;
import ehnetwork.game.microgames.gui.privateServer.button.EditRotationButton;
import ehnetwork.game.microgames.gui.privateServer.button.GameVotingButton;
import ehnetwork.game.microgames.gui.privateServer.button.GiveAdminButton;
import ehnetwork.game.microgames.gui.privateServer.button.KillButton;
import ehnetwork.game.microgames.gui.privateServer.button.OptionsButton;
import ehnetwork.game.microgames.gui.privateServer.button.PlayerHeadButton;
import ehnetwork.game.microgames.gui.privateServer.button.RemoveAdminButton;
import ehnetwork.game.microgames.gui.privateServer.button.SetGameButton;
import ehnetwork.game.microgames.gui.privateServer.button.StartGameButton;
import ehnetwork.game.microgames.gui.privateServer.button.StopGameButton;
import ehnetwork.game.microgames.gui.privateServer.button.UnbanButton;
import ehnetwork.game.microgames.gui.privateServer.button.WhitelistButton;

public class MenuPage extends BasePage
{
	public MenuPage(MicroGamesManager plugin, PrivateServerShop shop, Player player)
	{
