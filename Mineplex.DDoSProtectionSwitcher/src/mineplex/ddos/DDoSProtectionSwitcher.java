...
*/
	...
	private static void sendMail()
	{
		...
		try
		{
			message.addRecipient(RecipientType.TO, new InternetAddress("adamg@theendlessweb.com"));
			message.addFrom(new InternetAddress[] { new InternetAddress("support@theendlessweb.com") });
