package ehnetwork.game.arcade.game.games.snake;
...
import ehnetwork.game.arcade.game.games.snake.kits.KitInvulnerable;
import ehnetwork.game.arcade.game.games.snake.kits.KitReverser;
import ehnetwork.game.arcade.game.games.snake.kits.KitSpeed;
import ehnetwork.game.arcade.kit.Kit;
import ehnetwork.game.arcade.stats.ChooChooStatTracker;
import ehnetwork.game.arcade.stats.KillsWithinGameStatTracker;
import ehnetwork.game.arcade.stats.SlimySheepStatTracker;
		...
		while (invIterator.hasNext())
		{
			...
			if (UtilTime.elapsed(_invul.get(player), 2000))
			{
				...
				if (disguise != null && disguise instanceof SheepDisguise)
					((SheepDisguise) disguise).setColor(_color.get(player));
			...
			Disguise disguise = Manager.GetDisguise().getDisguise(player);
			if (disguise != null && disguise instanceof SheepDisguise)
				((SheepDisguise) disguise).setColor(col);
