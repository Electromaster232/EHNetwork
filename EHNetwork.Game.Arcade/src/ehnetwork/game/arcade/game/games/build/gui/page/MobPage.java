package ehnetwork.game.arcade.game.games.build.gui.page;
...
import ehnetwork.game.arcade.game.games.build.gui.MobShop;
...
public class MobPage extends ShopPageBase<ArcadeManager, MobShop>
{
	...
	protected void buildPage()
	{
		...
		if (_entity instanceof LivingEntity)
		{
			...
			final boolean ghost = ((CraftLivingEntity) livingEntity).getHandle().dead;
			...
			addButton(buttonSlot, item, new IButton()
			{
				...
				public void onClick(Player player, ClickType clickType)
				{
					((CraftLivingEntity) livingEntity).getHandle().dead = !ghost;
