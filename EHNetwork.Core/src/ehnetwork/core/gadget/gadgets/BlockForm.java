...
public class BlockForm
{
	...
	public void Apply() 
	{
		...
		//Player > Chicken
		Disguise d1 = _host.Manager.getDisguiseManager().createDisguise(EntityType.CHICKEN);
		MobDisguise d2 = (MobDisguise) d1;
		//d2.setCustomName(player.getName() + _host.Manager.getClientManager().Get(player).GetRank());
		//d2.setCustomNameVisible(true);
		d2.setVisibility(Disguise.Visibility.ONLY_PERMISSION);
		_host.Manager.getDisguiseManager().applyDisguise(d2, _player);
