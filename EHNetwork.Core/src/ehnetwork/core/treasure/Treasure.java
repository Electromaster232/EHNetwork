...
import ehnetwork.core.treasure.animation.Animation;
import ehnetwork.core.treasure.animation.BlockChangeAnimation;
import ehnetwork.core.treasure.animation.ChestOpenAnimation;
import ehnetwork.core.treasure.animation.ChestSpawnAnimation;
import ehnetwork.core.treasure.animation.LootLegendaryAnimation;
import ehnetwork.core.treasure.animation.LootMythicalAnimation;
import ehnetwork.core.treasure.animation.LootRareAnimation;
import ehnetwork.core.treasure.animation.LootUncommonAnimation;
import ehnetwork.core.treasure.animation.TreasureRemoveAnimation;
...
public class Treasure
{
	...
	public void update()
	{
		...
		Block block = _player.getTargetBlock((HashSet<Byte>) null, 3);
	...
	public void sendChestOpenPackets(Player... players)
	{
		for (ChestData data : _chestData)
		{
			if (data.isOpened())
			{
				...
				PacketPlayOutBlockAction packet = new PacketPlayOutBlockAction(b1, CraftMagicNumbers.getBlock(block), 1, 1);
